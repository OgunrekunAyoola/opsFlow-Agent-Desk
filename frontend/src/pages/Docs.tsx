        ...
        <div className="grid grid-cols-1 md:grid-cols-[220px,minmax(0,1fr)] gap-12">
          <aside className="space-y-6">
            ...
            <nav className="space-y-1 text-sm">
              <a href="#overview" className="block text-white/70 hover:text-white">
                Overview
              </a>
              <a href="#authentication" className="block text-white/70 hover:text-white">
                Authentication
              </a>
              <a href="#tickets-ai" className="block text-white/70 hover:text-white">
          ...
          <div className="space-y-12">
            <section id="overview" className="space-y-3">
              ...
              <div className="glass-panel rounded-2xl p-4 text-xs text-white/70">
                <div className="mb-2 font-medium text-white">Base URL</div>
            ...
            <section id="authentication" className="space-y-4">
              <h2 className="text-xl font-heading font-semibold">Authentication</h2>
              ...
              <div className="glass-panel rounded-2xl p-4 space-y-3 text-sm text-white/80">
                ...
                <div>
                  <div className="text-xs font-medium text-white/70 mb-2">Authorization header</div>
            ...
            <section id="tickets-ai" className="space-y-4">
              <h2 className="text-xl font-heading font-semibold">Tickets and AI workflows</h2>
              <p className="text-sm text-white/80 max-w-2xl">
